...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 用来表示一个bean的示例依靠另一个bean先实例化，对应bean属性depend-on
	 */
	@Nullable
	...
	/**
	 * 是否时用户定义的而不是应用程序本身定义的，创建AOP时为true，程序设置
	 */
	private boolean synthetic = false;

	/**
	 * 定义这个bean的应用， APPLICATION：用户，INFRASTRUCTURE：完全内部使用与用户无关， SUPPORT：某些复杂配笠的一部分
	 * 程序设置
	 */
